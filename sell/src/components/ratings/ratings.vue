<template>
  <div class="ratings" ref="ratings">
    <div class="ratings-content">
      ...
      <split></split>
      <rating-select :select-type="selectType" :only-content="onlyContent"  :ratings="ratings" @ratingtype_select="ratingtype_select" @content_toggle="content_toggle"></rating-select>
